                                    ...
                                    {!file ? (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <button
                                                ...
                                                disabled={uploading}
                                                className="px-6 py-3 bg-linear-to-r from-blue-600 to-indigo-700 text-white rounded-lg hover:from-blue-700 hover:to-indigo-800 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
